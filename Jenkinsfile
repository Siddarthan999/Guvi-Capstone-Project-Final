pipeline {
    ...
    stages {
        ...
        stage('Deploy to Minikube') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'minikube', contextName: 'minikube', credentialsId: 'minikube-jenkins-secret', namespace: 'default', restrictKubeConfigAccess: false, serverUrl: 'https://127.0.0.1:55429') {
                    script {
                        try {
